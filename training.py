...
resnet_models=[models.resnet101, models.resnet101, models.resnet101, models.resnet101]  # CHANGE
string_graph_names = ["ResNet101", "ResNet101", "ResNet101", "ResNet101"]  # CHANGE
dropouts=[False, False, True, True]  # CHANGE
prob_drops=[0.5, 0.5, 0.5, 0.5] 
opts=[torch.optim.SGD, torch.optim.Adam, torch.optim.SGD, torch.optim.Adam]  ## CHANGE
tags = ["resnet101_dropout_False_opt_SGD_lr_{}", "resnet101_dropout_False_opt_ADAM_lr_{}", "resnet101_dropout_True_opt_SGD_lr_{}", "resnet101_dropout_True_opt_ADAM_lr_{}", ]
