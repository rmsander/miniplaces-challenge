...
def request_generate_teamid(team_name, kerb1, kerb2):
    ...
    if gen_id is None:
        print("Team ID generation failed! Are your kerberoses valid, and registered? (do not include teammates who are listeners)")
        sys.exit(1)
    else:
...
def show_aws_credits():
    print("Please visit https://forms.gle/kofcjNusHx9ZJFfk7 to request credits.")
